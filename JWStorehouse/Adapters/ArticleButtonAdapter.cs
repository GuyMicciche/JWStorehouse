    ...
    public class ArticleButtonAdapter : BaseAdapter
    {
        ...
        public override View GetView(int position, View convertView, ViewGroup parent)
        {
            ...
            else
            {
                ...
                view.SetTextColor(context.Resources.GetColorStateList(Resource.Color.metro_button_text_style));
                view.SetTypeface(face, TypefaceStyle.Normal);
                view.SetBackgroundResource(Resource.Drawable.metro_button_style);
