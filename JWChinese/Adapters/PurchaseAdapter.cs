...
namespace JWChinese
{
    ...
    public class PurchaseAdapter : BaseAdapter<Purchase>
    {
        ...
        /// <summary>
        /// Gets the list of items attached to this <see cref="JWChinese.PurchaseAdapter"/> 
        /// </summary>
        ...
        #region Constructors
        /// <summary>
        /// Initializes a new instance of the <see cref="JWChinese.PurchaseAdapter"/> class.
        /// </summary>
        /// <param name="context">Context.</param>
        /// <param name="purchases">Purchases.</param>
        public PurchaseAdapter(Activity context, IList<Purchase> purchases)
            : base()
        {
            _context = context;
